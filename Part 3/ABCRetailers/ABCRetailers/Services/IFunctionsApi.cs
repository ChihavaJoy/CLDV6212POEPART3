...
public interface IFunctionsApi
{
    ...
    Task<Customer?> GetCustomerByUsernameAsync(string username); // For username lookup
    ...
    // Orders
    Task<Order> CreateOrderAsync(string customerId, string productId, int quantity, DateTime orderDate);
